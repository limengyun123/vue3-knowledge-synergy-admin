<template>
  <div style="width: 800; height: 700; overflow: auto;">
    ...
    <a-checkbox-group v-model:value="checkboxSelectedValues" style="width: 700px; height: 400px;">
      <infinite-scroll ref="child" @checkBoxClick="handleCheckBoxClick" :reqData="reqData" :updateSelected="updateSelectedValues" :pageSize="pageSize" :slotHeight="30">
...
import InfiniteScroll from './children-mass-memory.vue';
